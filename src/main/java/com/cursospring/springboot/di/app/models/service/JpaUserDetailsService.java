...
import com.cursospring.springboot.di.app.models.dao.IUsuarioDao;
import com.cursospring.springboot.di.app.models.entity.Role;
...
public class JpaUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		...
		if(authorities.isEmpty()) {
			logger.error("No tiene roles asignado");
			throw new UsernameNotFoundException("username " + username + " no existe");
		}
